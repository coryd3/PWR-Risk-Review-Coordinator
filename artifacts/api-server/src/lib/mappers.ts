...
export function mapRequest(row: RiskReviewRequestRow) {
  return {
    ...
    region: row.region,
    legalMissingExplanation: row.legalMissingExplanation,
    ...
    riskIdentificationDate: row.riskIdentificationDate,
    riskIdentificationExplanation: row.riskIdentificationExplanation,
