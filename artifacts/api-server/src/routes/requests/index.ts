...
router.post("/requests", async (req: Request, res: Response): Promise<void> => {
  ...
  const inserted = await db
    ...
    .values({
      ...
      legalMissingExplanation: body.legalMissingExplanation ?? null,
      ...
      riskIdentificationDate: body.riskIdentificationDate ?? null,
      riskIdentificationExplanation: body.riskIdentificationExplanation ?? null,
